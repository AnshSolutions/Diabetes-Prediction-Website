      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-start items-start px-4 md:px-15 lg:px-100 space-y-8 md:space-y-0">
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <div className="flex space-x-4 text-2lg">
            ...
            <a href="https://www.linkedin.com/in/ansh-kumar-5a40a3249/" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaLinkedinIn className="text-2xl" />
            </a>
            <a href="https://github.com/AnshSolutions" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaGithub className="text-2xl" />
            </a>
            <a href="https://quora.comi" className="text-white hover:text-gray-400 transition-colors duration-300">
